...
namespace Framework {
    ...
    class Inspector {
        ...
        protected function _getPropertyComment() {
            $reflection = new \ReflectionClass($this->_class, $property);
            return $reflection->getDocCommen();
        }

        protected function _getMethodComment() {
        ...
        public function getClassMeta() {
            if (!isset($_meta["class"])) {
                $comment = $this->_getClassComment($comment);
                if (!empty($comment)) {
        ...
        public function getMethodMeta($method) {
            if (!isset($_meta["properties"][$method])) {
                $comment = $this->_getPropertyComment($method);
                if (!empty($comment)) {
